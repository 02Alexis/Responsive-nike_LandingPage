  ...
  return (
    <div>
      <div className='container'>
        ...
        <Hero handleColor={handleColor} buttonStyle={selectedStyle.buttonStyle} shoesStyle={selectedStyle.shoesStyle} selectedColorStyle={selectedStyle.selectedColorStyle} />
        <Background />
        <Nike />
      </div>
    </div>
